...
tf.app.flags.DEFINE_integer("en_vocab_size", 3465, "English vocabulary size.")
tf.app.flags.DEFINE_integer("fr_vocab_size", 3465, "French vocabulary size.")
...
_buckets = [(7, 7), (9, 9), (12, 12), (16, 16)] #min=4,max=16
...
def create_model(session, forward_only):
    ...
    print("ckpt",ckpt)
    print("exist", tf.gfile.Exists(ckpt.model_checkpoint_path))
    saver = tf.train.Saver() # change this can
    ...
    # init = tf.global_variables_initializer() # new
    # session.run(init)
